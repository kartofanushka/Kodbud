...
class Ball:
    def __init__(self, canvas, platform, color):
        ...
        self.sound = pygame.mixer.Sound("12-2/sound.mp3")
...
canvas.pack()
img = Image.open("12-2/bg.png")
img = img.resize((500, 400))
img = ImageTk.PhotoImage(img)
canvas.create_image(250, 200, image=img)

platform = Platform(canvas, "navy")
balls = [Ball(canvas, platform, "pink") for i in range(10)]
end = True
while end:
    end = False
    for ball in balls:
    ...
    time.sleep(0.01)
# root.mainloop()
# bg_img=PhotoImage(file="12-2/bg.png")
